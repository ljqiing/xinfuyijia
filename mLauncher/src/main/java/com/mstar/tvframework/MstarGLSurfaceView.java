...
public class MstarGLSurfaceView extends BaseGLSurfaceView {
    ...
    public MstarGLSurfaceView(Context context, boolean translucent, int depth, int stencil) {
        super(context);
    ...
    private class Renderer implements BaseGLSurfaceView.Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
            ...
            if (MstarGLSurfaceView.this.getContext() instanceof Mstar3DUIActivity) {
                Mstar3DUIActivity activityMstar3DUI = (Mstar3DUIActivity) MstarGLSurfaceView.this
                        .getContext();
